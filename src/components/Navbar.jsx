  ...
  return (
    <div className="fixed w-full h-[98px] flex justify-between items-center px-6 bg-transparent md:bg-[#059F9B] text-white shadow-transparent md:shadow-md z-50">
      ...
      <ul className="hidden md:flex space-x-6 text-lg font-medium">
        ...
        <li>
          <Link to="participations" smooth={true} duration={500} className="hover:text-[#DF90AD] transition-colors duration-300 cursor-pointer">
            Participaciones
          </Link>
        </li>
        <li>
      ...
      >
        ...
        <li className="py-6 text-4xl">
          <Link onClick={handleClick} to="participations" smooth={true} duration={500} className="hover:text-[#DF90AD] transition-colors duration-300 cursor-pointer">
            Participaciones
          </Link>
        </li>
        <li className="py-6 text-4xl">
